  ...
  return (
    <div className="how-reporting-works-page">
      ...
      <main>
        ...
        <section style={{ padding: "35px 0 25px 0", background: "var(--paper)" }}>
          <div className="container">
                  ...
                  <div className="step-flip-card" tabIndex={0}>
                    <div className="step-flip-inner">
                      <div className="step-flip-front">
                        <div>
                          <span className="step-num-badge" title="Study Received">
                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>
                          </span>
                ...
                <div className="step-card-col">
                  <div className="step-flip-card" tabIndex={0}>
                    <div className="step-flip-inner">
                      <div className="step-flip-front">
                        <div>
                          <span className="step-num-badge" title="Radiologist Assigned">
                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="17" y1="11" x2="23" y2="11"></line></svg>
                          </span>
                ...
                <div className="step-card-col">
                  <div className="step-flip-card" tabIndex={0}>
                    <div className="step-flip-inner">
                      <div className="step-flip-front">
                        <div>
                          <span className="step-num-badge" title="Report Drafted">
                      ...
                      <div className="step-flip-front">
                        <div>
                          <span className="step-num-badge" title="Quality Check">
                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path><polyline points="9 12 11 14 15 10"></polyline></svg>
                          </span>
                ...
                <div className="step-card-col">
                  <div className="step-flip-card" tabIndex={0}>
                    <div className="step-flip-inner">
                      <div className="step-flip-front">
                        <div>
                          <span className="step-num-badge active-badge" title="Report Delivered">
                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
                          </span>
                      ...
                      <div className="step-flip-back step-detail-card" style={{ borderColor: "rgba(43, 168, 183, 0.4)" }}>
                        <span className="step-num-badge active-badge">
                          <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
                        </span>
                    ...
                    <div className="step-flip-inner">
                      ...
                      >
                        <div>
                          ...
                          >
                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="8" rx="2" ry="2"></rect><rect x="2" y="14" width="20" height="8" rx="2" ry="2"></rect><line x1="6" y1="6" x2="6.01" y2="6"></line><line x1="6" y1="18" x2="6.01" y2="18"></line></svg>
                          </span>
